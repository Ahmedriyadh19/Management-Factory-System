...
class DisplaySalesInvoicePage extends StatefulWidget {
  const DisplaySalesInvoicePage({Key? key, this.option, this.appBarTitle}) : super(key: key);
  final int? option;
  final String? appBarTitle;
  @override
  State<DisplaySalesInvoicePage> createState() => _DisplaySalesInvoicePageState();
}
